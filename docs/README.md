...
在浏览器中访问 https://github.com 并点击右上角的 “Sign Up” 来注册。具体步骤可以参考 [在 GitHub 上创建帐户](https://docs.github.com/zh/get-started/start-your-journey/creating-an-account-on-github) 。

### 第一个仓库

如果想要上传项目到 GitHub，那么这一步是必须的。
